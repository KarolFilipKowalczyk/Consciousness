...
$M_{30}$ capacity & $2^{30}$ = 1G bits (realistic working memory) \\
Typical use & $M_{15}$ to $M_{30}$ (32K-1G bits) \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
$M_{10}$ & $2^{10}$ = 1K bits & $\sim$50 ms & Basic perception \\
$M_{15}$ & $2^{15}$ = 32K bits & $\sim$100 ms & Feature binding \\
$M_{20}$ & $2^{20}$ = 1M bits & $\sim$200 ms & Object recognition \\
$M_{25}$ & $2^{25}$ = 32M bits & $\sim$400 ms & Working memory \\
$M_{30}$ & $2^{30}$ = 1G bits & $\sim$800 ms & Planning \\
$M_{35}$ & $2^{35}$ = 32G bits & $\sim$1.6 s & Complex reasoning \\
\bottomrule
\end{tabular}
\end{table}
