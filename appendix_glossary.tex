...
\midrule
$M_{10}$ & $2^{10}$ = 1K bits & $\sim 10^{308}$ & Basic & Simple reflexes\\
$M_{15}$ & $2^{15}$ = 32K bits & $\sim 10^{9864}$ & Moderate & Pattern recognition\\
$M_{20}$ & $2^{20}$ = 1M bits & $\sim 10^{301030}$ & Rich & Working memory\\
$M_{25}$ & $2^{25}$ = 32M bits & $\sim 10^{9.6 \times 10^6}$ & Very rich & Complex reasoning\\
$M_{30}$ & $2^{30}$ = 1G bits & $\sim 10^{3 \times 10^8}$ & Extreme & Expert performance\\
$M_{35}$ & $2^{35}$ = 32G bits & Astronomical & Peak & Peak consciousness\\
$M_{40}$ & $2^{40}$ = 1T bits & Beyond enumeration & Maximal & Theoretical limit\\
\bottomrule
\end{tabular}
\end{table}
